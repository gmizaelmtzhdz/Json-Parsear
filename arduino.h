...
class Transportadora{
	...
	public:
		...
		void establecerTelefonos(int telefonos[],int tamano);
		
};
void Transportadora::imprimir()
{
	printf("%.2f\n",this->temperatura_min);
	printf("%.2f\n",this->temperatura_max);
}
...
void Transportadora::establecerTelefonos(int telefonos[],int tamano)
{
	int i;
	for(i=0;i<tamano;i++)
	{
